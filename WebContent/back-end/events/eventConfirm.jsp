					...
					<tbody>
						<c:forEach var="eventVO" items="${list}">
							<tr>
								...
								<td><a href="<%=request.getContextPath()%>/event/EventServlet?action=getOne_For_Update&event_id=${eventVO.event_id}"><span>${eventVO.event_title}</span></a></td>
								<td><img
								...
								<td>
									...
									<FORM METHOD="post"
										...
										<input type="submit" value="未通過" class="del_btn"> <input
