...
<%@ include file="/back-end/sb/page1.file"%>
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="/img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                                            src="<%=request.getContextPath()%>/vendors/sb-admin-2/img/undraw_posting_photo.svg" alt="">
                                    </div>
    ...
    <!-- Page level plugins -->
    <script src="<%=request.getContextPath()%>/vendors/sb-admin-2/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="<%=request.getContextPath()%>/vendors/sb-admin-2/js/demo/chart-area-demo.js"></script>
    <script src="<%=request.getContextPath()%>/vendors/sb-admin-2/js/demo/chart-pie-demo.js"></script>
