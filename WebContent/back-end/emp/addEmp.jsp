...
<table>
	<tr>
		...
		<td><input type="TEXT" name="emp_password" size="45"  
			 value="<%= (empVO==null)? "1" : empVO.getEmp_password()%>" /></td> 
	</tr>
	<tr>
		<td>新增日期:</td>
	...
	<tr>
		...
		<td><input type="TEXT" name="emp_mail" size="45"
			 value="<%= (empVO==null)? "oooxxx@gmail.com" : empVO.getEmp_mail()%>" /></td>
	</tr>
	<tr>
		<td>手機:</td>
		<td><input type="TEXT" name="emp_phone" size="45"
			 value="<%= (empVO==null)? "0900064666" : empVO.getEmp_phone()%>" /></td>
	</tr>
	<tr>
		<td>員工狀態:</td>
	...
	<tr>
		<td>員工認證:</td>
		<td><input type="TEXT" name="emp_auth" size="45"
			 value="<%= (empVO==null)? 1 : empVO.getEmp_auth()%>" /></td>
	</tr>
	<tr>
		<td>編輯:</td>
		<td><input type="TEXT" name="emp_last_editor" size="45"
			 value="<%= (empVO==null)? "內容" : empVO.getEmp_last_editor()%>" /></td>
	</tr>
