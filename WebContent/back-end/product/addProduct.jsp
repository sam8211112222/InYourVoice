...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/front-end/product/select_page.jsp"><img src="<%=request.getContextPath()%>/front-end/images/pic.jpg" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="band_id" size="45" 
			 value="<%= (productVO==null)? "BAND00000" : productVO.getBand_id()%>" /></td>
	</tr>
	<tr>
		<td>商品分類:</td>
	...
	<tr>
		<td>最後修改者:</td>
		<td><input type="TEXT" name="product_last_editor" size="45" 
			 value="<%= (productVO==null)? "BAND00000" : productVO.getProduct_last_editor()%>" /></td>
	</tr>

</table>
<br>
<input type="hidden" name="action" value="insert">
<input type="submit" value="送出審核"></FORM>
</body>
