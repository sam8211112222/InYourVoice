	...
	<table id="table-1">
		<tr>
			<td>
				...
				<h4>
					<a href="<%=request.getContextPath()%>/back-end/select_page.jsp"><img src="<%=request.getContextPath() %>/images/back1.gif"
		...
		<table>
			...
			<tr>
				...
				<td><input type="TEXT" name="memberGender" size="45"
					value="<%=memberVo.getMemberGender()%>" /></td>
			</tr>
			<tr>
				<td>電話:</td>
			...
			<tr>
				...
				<td><input type="TEXT" name="memberMsgAuth" size="45"
					value="<%=memberVo.getMemberMsgAuth()%>" /></td>
			</tr>
			<tr>
				<td>藝人編號:</td>
				<td><input type="TEXT" name="bandId" size="45"
					value="<%=memberVo.getBandId()%>" /></td>
			</tr>
			<tr>
				<td>加入日期:</td>
				<td><input type="TEXT" name="sal" size="45" readonly
					value="<fmt:formatDate value="${memberVo.addTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" /></td>
			</tr>
