...
<body bgcolor='white'>
	...
	<FORM METHOD="post" enctype="multipart/form-data" ACTION="pieces.do" name="form1">
		<table>
			<tr>
				<td>piece_id:</font></td>
			...
			<tr>
				<td>album_id:</td>
				<td><input type="TEXT" name="album_id" size="45" value="${piecesVO.album_id}" /></td>
			</tr>
			<tr>
				<td>piece:</td>
				<td>
					<input type="file" name="piece" size="45"/>
				</td>
			</tr>
			<tr>
				<td>piece_status:</td>
			...
			<tr>
				...
				<td><input type="TEXT" readonly name="piece_play_count" size="45" value="${piecesVO.piece_play_count}" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="TEXT" readonly name="piece_last_editor" size="45" value="${piecesVO.piece_last_editor}" /></td>
			</tr>
		</table>

		<br> <input type="hidden" name="action" value="update"> 
		<input type="hidden" name="piece_id" value="${piecesVO.piece_id}"> <input type="submit" value="送出修改">
	</FORM>
