						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="p-5">
									...
									<form class="user" action="<%=request.getContextPath()%>/EmpServlet"
										method="POST">
										<div class="form-group">
											<input type="email" name="empEmail" class="form-control form-control-user"
												id="empMail" aria-describedby="emailHelp"
												placeholder="Enter Email Address...">
										</div>
										<div class="form-group">
											<input type="password" name="empPassword" class="form-control form-control-user"
