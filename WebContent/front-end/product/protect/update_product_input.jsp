...
<table align="center">
	...
	<tr>
		<td>樂團編號:</td>
		<td><%=productVO.getBand_id() %><input type="hidden" name="band_id" value="${productVO.band_id}"></td>
	</tr>
	<tr>
		<td>商品分類:</td>
		<td>
	...
	<tr>
		<td>商品庫存量:</td>
		<td><input type="number" min="0" name="product_stock" size="15"
	...
	<tr>
		<td>折扣:</td>
		<td><input type="number" name="product_discount" placeholder="1.0" step="0.01" min="0.0" max="1.0" size="15"
	...
	<tr>
		<td>最後修改者:</td>
		<td><%=productVO.getProduct_last_editor() %><input type="hidden" name="product_last_editor" value="${productVO.product_last_editor}"></td>
    </tr>
