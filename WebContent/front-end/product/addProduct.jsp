...
<table>
	...
	<tr>
		...
		<td><input type="text" name="band_id"size="45"
			 value="<%= (productVO==null)? "" : productVO.getBand_id()%>" /></td>
	</tr>
	<tr>
		<td>商品分類:</td>
	...
	<tr>
		<td>商品庫存量:</td>
		<td><input type="number" min="1" name="product_stock" size="45"
	...
	<tr>
		...
		<td><input type="text" name="product_last_editor"size="45"
			 value="<%= (productVO==null)? "" : productVO.getProduct_last_editor()%>" /></td>
	</tr>
