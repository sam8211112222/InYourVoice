...
<body onload="connect();" onunload="disconnect();">
		...
		<div class="card-form">
			<form action="<%=request.getContextPath()%>/EventOrderController"
				...
				<div class="card-form__inner">
					...
					<input type="hidden" name="action" value="check-out"> <input
						type="hidden" name="event_id" value="${event_id}">
					...
					<a
						href="<%=request.getContextPath()%>/EventOrderController?action=cancel&event_id=${event_id}"><button
							type="button" class="card-form__button" id="cancelbutton">cancel</button></a>
				</div>
			</form>
		</div>
	</div>
	...
	<script
		src="<%=request.getContextPath()%>/front-end/eventorder/vendors/jquery/jquery-3.5.1.min.js"></script>
	<script>
