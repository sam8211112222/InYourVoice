			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="section-body">
						<div class="form-group">
							...
							&nbsp;&nbsp;<span id="order-customer-name-span"
								style="color: red;"></span> <input id="order-customer-name"
								type="text" class="form-control" name="orderName" value="">
						</div>
						<div class="form-group">
							<label for="order-customer-mail" class="control-label">電子信箱</label>
							&nbsp;&nbsp;<span id="order-customer-mail-span"
								style="color: red;"></span> <input id="order-customer-mail"
								type="text" class="form-control" name="orderMail" value="">
						</div>
						<div class="form-group">
							<label for="order-customer-phone" class="control-label">連絡電話</label>
							&nbsp;&nbsp;<span id="order-customer-phone-span"
								style="color: red;"></span> <input id="order-customer-phone"
								type="text" class="form-control" name="orderPhone" value="">
						</div>
					</div>
					<hr class="new3" size="12px" align="center" width="100%"
						color="#f9595f">
					<section class="remark-form">
						...
						<div class="section-body">
							<div class="form-group">
								<textarea id="order-remarks" class="form-control" name="remarks"
									placeholder="有什麼想告訴賣家嗎？" rows="3"></textarea>
							</div>
