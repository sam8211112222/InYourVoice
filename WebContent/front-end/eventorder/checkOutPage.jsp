...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/front-end/eventorder/css/index.css">
</head>
<body>
	<div class="wrapper" id="app">
		<div class="card-form">
			<form action="<%=request.getContextPath()%>/EventOrderController"
				method="post">
				<div class="card-list">
							...
							<div class="card-item__wrapper">
								<div class="card-item__top">
									...
									<div class="card-item__type">
										<transition name="slide-fade-up"> <img
											...
											class="card-item__typeImg"> </transition>
									</div>
								</div>
								<label for="cardNumber" class="card-item__number"
									ref="cardNumber"> <template
										v-if="getCardType === 'amex'"> <span
										v-for="(n, $index) in amexCardMask" :key="$index"> <transition
											name="slide-fade-up">
									...
									</span> </template> <template v-else> <span
										v-for="(n, $index) in otherCardMask" :key="$index"> <transition
											name="slide-fade-up">
										<div class="card-item__numberItem"
								...
								<div class="card-item__content">
									<label for="cardName" class="card-item__info" ref="cardName">
										<div class="card-item__holder">Card Holder</div> <transition
											name="slide-fade-up">
									...
									<div class="card-item__date" ref="cardDate">
										...
										<label for="cardMonth" class="card-item__dateItem"> <transition
												name="slide-fade-up"> <span v-if="cardMonth"
												v-bind:key="cardMonth">{{cardMonth}}</span> <span v-else
												key="2">MM</span> </transition>
										</label> / <label for="cardYear" class="card-item__dateItem">
											<transition name="slide-fade-up"> <span
												v-if="cardYear" v-bind:key="cardYear">{{String(cardYear).slice(2,4)}}</span>
											<span v-else key="2">YY</span> </transition>
										</label>
									</div>
								</div>
							</div>
				...
				<div class="card-form__inner">
					<div class="card-input">
						<label for="cardNumber" class="card-input__label">信用卡 卡號</label> <input
							type="text" id="cardNumber" class="card-input__input"
					...
					<div class="card-input">
						<label for="cardName" class="card-input__label">持卡人 姓名</label> <input
							type="text" id="cardName" class="card-input__input"
					...
					<div class="card-form__row">
						<div class="card-form__col">
							<div class="card-form__group">
								<label for="cardMonth" class="card-input__label">有效期限</label> <select
									class="card-input__input -select" id="cardMonth"
						...
						<div class="card-form__col -cvv">
							<div class="card-input">
								<label for="cardCvv" class="card-input__label">安全碼</label> <input
					...
					<div class="card-input">
						<label  class="card-input__label">收件人 姓名</label> <input
							type="text" id="Recipient" class="card-input__input" name="order_name">
					</div>
					<div class="card-input">
						<label  class="card-input__label">收件人 電子信箱</label> <input
							type="text" id="Recipient" class="card-input__input" name="order_mail">
					</div>
					<div class="card-input">
						<label  class="card-input__label">收件人 連絡電話</label> <input
							type="text" id="Recipient" class="card-input__input" name="order_phone">
					</div>
	...
	<script
		src="<%=request.getContextPath()%>/front-end/eventorder/js/index.js"></script>
