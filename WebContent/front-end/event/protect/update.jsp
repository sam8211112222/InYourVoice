	...
	<div>
		...
		<FORM METHOD="post"	ACTION="<%=request.getContextPath()%>/MemberCenterEventController"  enctype="multipart/form-data">
			<div>
				...
				<div class="inputblock">
					<span>活動狀態:</span> <span><select class="inputborder"
						name="event_status" size="1">
							<option value="0"
			...
			<div id="ticket_block">
				...
				<input type="submit" value="送出修改" id="submit" class="inputborder" >
		</FORM>
		<br>
...
<script>
    ...
    function addTicket() {
            $("#ticket_block").prepend(`<div class="ticket"><div class="inputblock"><span>請輸入票種名稱:<input type="text" class="inputborder" name="ticket_name"></span><span>票種金額:<input class="inputborder" type="text" name="ticket_price" size="5"></span>
                    <span>票種總張數:<input type="text" class="inputborder" name="ticket_amount" size="5"></span>
                    ...
                    <div class="inputblock"><span>票券販售狀態<select name="ticket_status" class="inputborder" size="1">
        			<option value="0" "selected">下架</option>
        			<option value="1">上架</option>
        			</select></span></div>
			<input type="hidden" class="inputborder" name="ticket_id" value="">
