...
<link href="<%=request.getContextPath()%>/front-end/event/css/event.css"
	media="all" rel="stylesheet">
<link rel="stylesheet" media="screen"
	href="<%=request.getContextPath()%>/front-end/event/css/event-font.css">
<script
	src="<%=request.getContextPath()%>/front-end/event/vendors/jquery/jquery-3.5.1.min.js"></script>
		...
		<div class="content-wrapper">
			<div class="content container">
				...
				<div class="organizers mobi-hide clearfix">
					<i class="fas fa-guitar"></i>主辦單位 <a
						href="<%=request.getContextPath()%>/band/band.do?action=getBandMain&band_id=${eventVO.band_id}">${bandVO.band_name}</a>
				...
				<div class="seat-banner">
					<img
						src="<%=request.getContextPath()%>/EventPicController?action=getEventSeat&event_id=${eventVO.event_id}">
				</div>
				<div class="location clearfix">
					<div id="map-container" class="side-content">
						<div class="map-wrapper">
							...
							<div id="map-content" data-lat="" data-lng=""
								style="width: 280px; height: 280px;" class="map-wrapper"></div>
						</div>
					</div>
					<div class="address">${eventVO.event_place}/
						${eventVO.event_address}</div>
					<div class="btn-group">
						<a href="https://maps.google.com/?daddr=${eventVO.event_address}"
							target="_blank" class="btn-view"> 規劃路線 </a> <a
							href="https://maps.google.com/maps?q=${eventVO.event_place}"
							target="_blank" class="btn-view"> 檢視較大的地圖 </a>
					</div>
				</div>
				<div>
					<c:choose>
								...
								pattern="yyyy/MM/dd HH:mm" /></span></span>
														...
														<td><div class="display-flex">
																<span class="qtyminus" id="qtyminus">-</span> <input
																	...
																	value="0" class="qty" readonly> <span
																	class="qtyplus" id="qtyplus">+</span> <input
																	type="hidden" name="ticket_id"
