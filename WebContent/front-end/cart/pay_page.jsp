...
.card-input__input.-select {
	...
	background-image:
		url("data:image/png;base64,");
			...
			<div class="card-form">
				...
				<div class="card-form__inner">
					<div class="card-input">
						<label for="cardNumber" class="card-input__label">信用卡卡號</label> <input
							name="cardNumber"
					...
					<div class="card-input">
						<label for="cardName" class="card-input__label">持卡人姓名</label> <input
							type="text" id="cardName" name="cardName" class="card-input__input"
					...
					<div class="card-form__row">
						<div class="card-form__col">
							<div class="card-form__group">
								<label for="cardMonth" class="card-input__label">到期日</label> <select
									class="card-input__input -select" id="cardMonth" name="cardMonth"
									...
									v-model="cardYear" v-on:focus="focusInput" name="cardYear"
									v-on:blur="blurInput" data-ref="cardDate">
						...
						<div class="card-form__col -cvv">
							<div class="card-input">
								<label for="cardCvv" class="card-input__label">安全碼</label> <input
									type="text" class="card-input__input" id="cardCvv" name="cardCvv"
					...
					<!-- 					<button class="card-form__button">送出</button> -->
				</div>
			</div>
