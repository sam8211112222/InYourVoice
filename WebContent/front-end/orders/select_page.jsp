...
<body>
<FORM METHOD="get" ACTION="${pageContext.request.contextPath}/front_end/orders/addOrders.jsp" >
...
<ul>
  <li><a href='${pageContext.request.contextPath}/front_end/orders/listAllOrders.jsp'>List</a> all Orders.  <br><br></li>
