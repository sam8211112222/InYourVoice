    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-2 d-block d-md-none">
                <!-- Component Start -->
            <div class=".d-block .d-md-none flex flex-col items-center w-16 h-full overflow-hidden text-gray-700 bg-gray-100 rounded">
            ...
            <div class="col-10">
<!--                 把內容放在這裡 -->
<%--                 <%@ include file="/front-end/band/album_management.jsp" %> --%>
