...
//		dao.testSelectAll(dao);
	...
	public void testInsert(AlbumDAO dao) {
		// 測試新增
	...
	public void testUpdate(AlbumDAO dao) {
		// 測試修改
	...
	public void testDelete(AlbumDAO dao) {
		// 測試刪除
		dao.delete("ALBUM00250");
		System.out.println("===deleted===");
	}

	public void testSelectOne(AlbumDAO dao) {
		// 測試查詢一筆
	...
	public void testSelectAll(AlbumDAO dao) {
		// 測試查詢多筆
	...
	public List<AlbumVO> getAllByBandId(String band_id) {
		...
		try {
			con = ds.getConnection();
			pstmt = con.prepareStatement(GET_ALL_BY_BAND_ID_PSTMT);
