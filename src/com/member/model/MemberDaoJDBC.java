...
public class MemberDaoJDBC implements MemberDao_interface{
	...
	private static final String INSERT_STMT="insert into members (member_Id,member_Account,member_Password,member_Gender,member_Phone,member_Address,member_Name,member_Nickname,member_Birth,member_Photo,member_Msg_Auth,member_Card_Number,member_Card_Expyear,member_Card_Expmonth,member_add_Time,band_Id) values('MEMBERS'||LPAD(members_seq.NEXTVAL, 5, '0'),?,?,?,?,?,?,?,?,empty_blob(),1,?,?,?,?,?)";
	...
	private static final String UPDATE_MEMBER_CARD="update members set member_Card_Number=?,member_Card_Expyear=?,member_Card_Expmonth=? where member_id=?";
