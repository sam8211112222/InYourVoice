...
import idv.david.websocketchat.model.ChatPartner;
...
public class FriendWS {
	...
	public void onOpen(@PathParam("userName") String userName, Session userSession) throws IOException {
		List<String> receiverList = JedisHandleMessage.getReceiverList(userName);
		ChatPartner cp = new ChatPartner("list", receiverList);
		userSession.getAsyncRemote().sendText(gson.toJson(cp));
